...
If using default qb-policeob, replace the following code to your app.js of your inventory:
```
...
If using hi-dev policejob, update the following code to your app.js of your inventory:
```
        // Custom Filled Evidence Bag using hi-dev policejob
        } else if (itemData.name == "filled_evidence_bag") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
                if (itemData.info.type == "casing") {
